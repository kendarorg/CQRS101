...
namespace TestUtils
{
    public class BaseTestOptimisticEntity<T>: BaseBusTest where T:IOptimisticEntity
    {
        protected T _saved;
        protected Mock<IOptimisticRepository<T>> _repository;

        protected override void Initialize()
        {
            base.Initialize();
            _saved = default(T);
            _repository = new Mock<IOptimisticRepository<T>>();
