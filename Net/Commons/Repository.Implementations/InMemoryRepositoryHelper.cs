...
{
    public class InMemoryIRepositoryHelper : IRepositoryHelper
    {
        ...
        public InMemoryIRepositoryHelper()
        {
        ...
        public IRepositoryHelper Create(Type clazz)
        {
            ...
            InMemoryIRepositoryHelper helper = new InMemoryIRepositoryHelper();
            helper.clazz = clazz;
